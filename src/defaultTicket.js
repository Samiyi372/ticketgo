...
export const defaultTicket = {
  ...
  colors: {
    ...
    mainBgImageColors: null,
    mainBgUseGradient: false,
    mainBgGradientType: "linear",
    mainBgMeshPositions: null,
    mainBgImagePosition: { x: 50, y: 50 },
    subBg: "#ffffff",
    subBgImage: null,
